...
"#;
    ...
    static CHEK2_CDS4_LINE: &str = r#"chr22	HAVANA	CDS	28699838	28699937	.	-	1	gene_id "ENSG00000183765.22"; transcript_id "ENST00000434810.5"; gene_type "protein_coding"; gene_name "CHEK2"; transcript_type "protein_coding"; transcript_name "CHEK2-214"; exon_number 4; exon_id "ENSE00003694540.1"; level 2; protein_id "ENSP00000416721.1"; transcript_support_level 3; hgnc_id "HGNC:16627"; tag "mRNA_start_NF"; tag "cds_start_NF"; havana_gene "OTTHUMG00000151023.24"; havana_transcript "OTTHUMT00000321183.1";
"#;
    ...
    lazy_static! {
        ...
        static ref CHEK2_CDS4: GtfRecord = GtfRecord {
            ...
            attributes: indexmap! {
                ...
                "transcript_id".to_string() => vec!["ENST00000434810.5".to_string()],
                ...
                "transcript_name".to_string() => vec!["CHEK2-214".to_string()],
                "exon_number".to_string() => vec!["4".to_string()],
                "exon_id".to_string() => vec!["ENSE00003694540.1".to_string()],
                "level".to_string() => vec!["2".to_string()],
                "protein_id".to_string() => vec!["ENSP00000416721.1".to_string()],
                "transcript_support_level".to_string() => vec!["3".to_string()],
                "hgnc_id".to_string() => vec!["HGNC:16627".to_string()],
                "tag".to_string() => vec!["mRNA_start_NF".to_string(), "cds_start_NF".to_string()],
                "havana_gene".to_string() => vec!["OTTHUMG00000151023.24".to_string()],
                "havana_transcript".to_string() => vec!["OTTHUMT00000321183.1".to_string()],
            },
        };
    }
    ...
    fn test_gtf_reader() {
        ...
        let values: Vec<_> = gtf_reader.collect();
        assert_eq!(values[0].as_ref().unwrap(), &*CHEK2P4_GENE);
        assert_eq!(values[14].as_ref().unwrap(), &*CHEK2_CDS4);
        assert_eq!(values.len(), 655);
    }
